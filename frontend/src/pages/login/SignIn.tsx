        ...
        >
          <div>
            ...
            <input
              ...
              placeholder="fluchten"
              className="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg w-full p-2.5 md:text-sm"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="text-white bg-ltertiary hover:bg-lquaternary rounded-lg text-sm font-medium w-full p-2.5"
          >
            Sign in
          </button>
        </form>

        <button className="text-white bg-[#00babc] hover:bg-[#33c8c9] border border-gray-500 rounded-lg text-sm font-medium w-full p-2.5">
          Sign in with 42
        </button>

        <div className="flex text-sm">
          <p className="font-light text-gray-500 dark:text-gray-400 mr-1">
